...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="md:hidden sticky top-[72px] z-20 bg-[#0a1420]/95 backdrop-blur-xl border-b border-white/[0.06]">
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={`
                relative flex items-center gap-1.5 px-4 py-3 whitespace-nowrap
            ...
            >
              ...
              {/* Active bottom bar */}
              {active && (
                <span className="absolute bottom-0 left-2 right-2 h-[2px] bg-gold rounded-t-full" />
              )}
            </Link>
          )
        })}
