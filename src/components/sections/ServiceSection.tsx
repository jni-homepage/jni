...
const TABS = [
  {
    ...
    point: '심사 통과율 96%의 신청 성공',
    desc1: '418건 이상의 성장 지원 사례를 기반으로 대표자별 성장 방향을 분석합니다.',
    desc2: '대표자 역량, 업종, 성장 목표를 정확히 분석하여 최적의 성장 자금을 추천합니다.\n\n정부 지원정보와 자금 정보를 신속하게 반영하여 항상 최신 정보에 기반한 분석을 제공합니다.',
  },
  {
    id: 'tab2',
    label: '맞춤 전략',
    ...
    point: '평균 조달금액 2.8억원 달성',
    desc1: '대표자 상황별 최적의 자금 전략을 수립하고 신청 계획을 설계합니다.',
    desc2: '대표자의 자금 필요 시기와 규모를 정밀하게 분석하여 최적의 자금조달 전략을 수립합니다.\n\n정보 제공부터 정책 활용까지 성공적인 자금 조달을 위한 체계적인 로드맵을 제시합니다.',
  },
  {
    id: 'tab3',
    label: '심사 준비',
    ...
    point: '재도전 승인률 98% 달성',
    desc1: '성장 자금 심사를 위한 서류 정보 및 증빙자료 안내를 완벽하게 지원합니다.',
    desc2: '서류 정보 제공, 재무제표 분석, 심사 요점 설명 등 심사기관의 기준을 정확히 안내합니다.\n\n신청 이후에도 지속적인 모니터링과 피드백으로 심사 통과를 위한 완벽한 준비를 지원합니다.',
  },
  {
    id: 'tab4',
    label: '전담 관리',
    ...
    point: '고객 재의뢰율 98%+ 달성',
    desc1: '업종별 성장 전문가가 신청부터 정산까지 전체 과정을 관리합니다.',
    desc2: '분석부터 신청, 심사, 정산까지 모든 단계를 전문가가 직접 지원합니다.\n\n대표님은 본업에만 집중하시고 복잡한 자금조달 절차는 제이앤아이 파트너스가 완벽하게 안내합니다.',
  },
]
      ...
      <div className="relative z-[1] max-w-wide mx-auto">
        ...
        <div className="text-center mb-6 md:mb-12 animate-fade-up">
          <h2 className="text-2xl md:text-[42px] lg:text-[48px] font-black text-light mb-2.5 uppercase tracking-wide leading-tight">
            성장 자금 조달의 <span className="text-gold animate-[neonGlowPulse_3s_ease-in-out_infinite]">전문 서비스</span>
          </h2>
          <p className="text-sm md:text-xl lg:text-[22px] text-body/90 font-medium tracking-wide">
            대표자 분석과 맞춤 전략으로 자금 조달 성공을 이루다
          </p>
