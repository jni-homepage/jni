...
export const pageMetadata: Record<string, Metadata> = {
  home: {
    title: '제이앤아이 파트너스 | 정책자금 경영컨설팅 전문기업',
    description:
      '정책자금 심사 통과율 96%, 418건 이상 성장 지원 실적의 제이앤아이 파트너스. 대표자 역량 분석부터 맞춤형 자금 전략 수립, 심사 대비까지 체계적 경영컨설팅을 제공합니다.',
    keywords:
      '정책자금, 경영컨설팅, 자금조달, 정부지원금, 창업자금, 운전자금, 시설자금, 제이앤아이 파트너스, 심사통과, 자금전략',
    openGraph: {
      title: '제이앤아이 파트너스 | 정책자금 경영컨설팅 전문기업',
      description:
  ...
  company: {
    title: '회사소개 | 제이앤아이 파트너스 - 정책자금 성장 전문 파트너',
    description:
      '제이앤아이 파트너스는 대표자 역량을 강화하는 성장 전문 파트너입니다. 전담 준비 지원, 체계적 프로세스, 투명한 운영으로 정책자금 심사 통과율 96%를 달성합니다.',
    openGraph: {
  ...
  process: {
    title: '진행과정 | 제이앤아이 파트너스 - 정책자금 성장 지원 프로세스',
    description:
      '제이앤아이 파트너스의 정책자금 성장 지원 6단계 프로세스. 정밀 역량 분석, 전문가 매칭, 맞춤형 자금 전략, 전과정 밀착 지원으로 심사 통과율 96%를 기록합니다.',
    openGraph: {
  ...
  fund: {
    title: '자금상담 | 제이앤아이 파트너스 - 정책자금·기업대출·보증서 전문',
    description:
      '정책자금 최대 10억, 기업대출 최대 30억, 보증서 최대 15억까지. 제이앤아이 파트너스의 맞춤형 자금 전략으로 평균 조달액 2.8억, 심사 통과율 96%를 달성하세요.',
    openGraph: {
  ...
  pro: {
    title: '전문서비스 | 제이앤아이 파트너스 - 법무·세무·회계·노무 전문가 네트워크',
    description:
      '법무, 세무, 회계, 노무 전문가를 맞춤형으로 연결하는 제이앤아이 파트너스. 418+ 성공 기업의 검증된 전문가 네트워크로 자금 조달 성공률을 높이세요.',
    openGraph: {
  ...
  mkt: {
    title: '온라인마케팅 | 제이앤아이 파트너스 - 데이터 기반 통합 마케팅',
    description:
