  ...
  const steps = [
    {
      ...
      title: '기업 역량 분석',
      items: ['신청 자격 및 조건 검토', '기업의 강점 및 개선점 분석', '필요한 전문 서비스 영역 파악', '개선 목표 및 일정 수립'],
    },
    {
      icon: (
        <svg className="w-10 h-10 fill-gold drop-shadow-[0_0_10px_rgba(212,175,55,0.5)]" viewBox="0 0 24 24">
      ...
      title: '전문가 매칭',
      items: ['법무, 세무, 회계, 노무 등 전문가', '기업 맞춤형 코치 구성', '역량강화 커리큘럼 개발', '서비스 범위 및 일정 확정'],
    },
    {
      icon: (
        <svg className="w-10 h-10 fill-gold drop-shadow-[0_0_10px_rgba(212,175,55,0.5)]" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: '완성 및 사후관리',
      items: ['최종 역량 평가 및 결과 검증', '신청 준비 완료 확인', '지속적 지원 체계 구축', '성공 후 사후관리 및 피드백'],
    },
  ]
        ...
        <div className="max-w-[1200px] mx-auto px-5 relative z-[1] overflow-visible">
          ...
          <div className="text-center mb-[30px] md:mb-[50px] overflow-visible">
            ...
            <p className="text-[12px] md:text-sm text-[rgba(232,212,168,0.8)] mt-4 leading-[1.6]">
              ※ 제이앤아이 파트너스는 기업 평가 및 진단, 컨설팅 및 자문, 서류작성 대행을 제공하지 않습니다.
              <br />
