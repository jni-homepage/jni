          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-[60px] items-center relative z-[1]">
            ...
            <div className="order-2 md:order-1">
              ...
              <p className="text-[14px] md:text-lg text-[rgba(224,242,241,0.75)] leading-[1.5] md:leading-[1.6] mb-6 md:mb-8">
                단순한 온라인 광고를 넘어, 기업의 전체적인 마케팅 전략을
                수립하고 실행합니다. 데이터 기반의 의사결정으로
                마케팅 ROI를 극대화합니다.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-5">
                {[
                  { number: '250%', label: '평균 매출 상승률' },
                  { number: '90%', label: '높은 고객만족도' },
                  { number: '72시간', label: '신규 캠페인 구축' },
                  { number: '15개', label: '채널 통합 관리' },
                ].map((benefit, i) => (
                  <div
                    key={i}
