  ...
  const features = [
    {
      ...
      title: '정밀한 역량 분석',
      desc: '전문가의 체계적 분석으로\n정책자금 적합도 극대화',
      items: ['대표자 역량 정밀 분석', '재무 건전성 분석', '성장 가능성 분석'],
    },
    {
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: '전문가 매칭 시스템',
      desc: '업종별 특화 전문가가\n직접 진행하는 지원',
      items: ['업종별 맞춤 전문가', '1:1 전담 지원', '실시간 진행 공유'],
    },
    {
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      title: '맞춤형 자금 전략',
      desc: '대표님 맞춤형\n정책자금 솔루션 설계',
      items: ['업종별 최적 매칭', '정책자금 발굴 지원', '자금 한도 최적화'],
    },
    {
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: '전과정 밀착 지원',
      desc: '신청부터 선정까지\n전 과정 밀착 지원',
      items: ['서류 정보 완벽 제공', '사업계획 전략 설계', '면접 대비 코칭'],
    },
    {
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: '지속적 사후 관리',
      desc: '선정 후에도 이어지는\n성장 파트너십',
      items: ['추가 자금 연계 지원', '정기 성장 분석', '지속 성장 지원'],
    },
  ]
  ...
  const faqs = [
    {
      ...
      a: '정책자금 심사 프로세스를 완벽히 이해한 전문가들이 대표님 맞춤형 솔루션을 제공합니다. 단순 서류작업이 아닌, 대표님의 숨은 가치를 발굴하고 성장 스토리를 설계하여 심사위원을 설득하는 전략적 접근법을 구사합니다. 대표님이 직접 진행하시기 전 사전 역량을 강화하여 96%의 높은 성공률을 달성하고 있습니다.',
    },
    {
    ...
    },
    {
      ...
      a: '정부 및 지자체가 운영하는 전 분야 지원사업을 커버합니다. 창업지원금, 운영자금, 시설투자, 기술개발(R&D), 해외진출, 각종 인증취득 등 대표님의 라이프사이클 전반의 자금을 지원합니다. 특히 잘 알려지지 않은 틈새 지원사업까지 발굴하여 자금 확보 가능성을 극대화해드립니다.',
    },
    {
      q: '서비스 이용 비용 체계는 어떻게 구성되어 있나요?',
      a: '기초 상담과 역량 분석은 전액 무료로 진행됩니다. 본격적인 지원 수수료는 지원 프로젝트의 성격과 난이도를 고려하여 산정되며, 직접 방문상담을 통해 맞춤형 견적을 제공해드립니다. 명확하고 공정한 가격 정책으로 예산 계획을 수립하실 수 있도록 돕겠습니다.',
    },
    {
      q: '접수부터 최종 지급까지 소요 기간은 어느 정도인가요?',
      a: '사업 유형별로 차이가 있으나 긴급운전자금은 3-4주 내, 일반 정책자금은 2-3개월 수준입니다. 제이앤아이 파트너스는 빠른 처리보다 최대 지원금액, 유리한 금리조건, 장기 상환조건 확보에 집중합니다. 철저한 준비를 통해 대표님에게 실질적 도움이 되는 최상의 결과를 만들어냅니다.',
    },
    {
      q: '자금 수령 이후에도 지속적인 관리를 받을 수 있나요?',
      a: '물론입니다. 제이앤아이 파트너스는 장기적 성장 파트너를 지향합니다. 자금 활용 모니터링, 후속 지원사업 추천, 추가 자금 조달 지원 등을 종합 제공합니다. 단발성 지원이 아닌 지속가능한 성장 기반을 함께 구축해나가겠습니다.',
    },
  ]
