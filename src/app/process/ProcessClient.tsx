...
function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: '정책자금 유형별로 차이가 있으나 긴급운전자금은 3-4주 내, 일반 정책자금은 2-3개월 수준입니다. 제이앤아이 파트너스는 빠른 처리보다 최대 자금조달 금액, 유리한 금리조건, 장기 상환조건 확보에 집중합니다. 철저한 심사통과 준비를 통해 대표님에게 실질적 도움이 되는 최상의 자금확보 결과를 만들어냅니다.',
    },
    {
      q: '자금 수령 이후에도 지속적인 관리를 받을 수 있나요?',
      a: '물론입니다. 제이앤아이 파트너스는 장기적 자금조달 성장 파트너를 지향합니다. 정책자금 활용 모니터링, 후속 정부지원 사업 추천, 추가 자금조달 지원 등을 종합 제공합니다. 단발성 컨설팅이 아닌 지속가능한 기업 성장 기반을 함께 구축해나가겠습니다.',
    },
  ]
