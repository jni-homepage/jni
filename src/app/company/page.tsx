    ...
    <section className="relative w-full min-h-[50vh] md:min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center px-4 md:px-10 pt-[130px] md:pt-[180px] pb-[60px] md:pb-[80px] lg:pb-[100px] overflow-hidden">
      ...
      <div className="relative z-[2] max-w-[1200px] mx-auto text-center animate-fade-up">
        ...
        <p className="text-[clamp(16px,2.5vw,24px)] text-[rgba(224,242,241,0.9)] leading-[1.6] max-w-[800px] mx-auto font-normal">
          대표자 역량을 강화하는 성장 전문 파트너<br />
          성공적인 자금확보를 위한 완벽한 준비, 심사 통과율 96%
        </p>
...
function CategorySection() {
  ...
  const categories = [
    {
      title: '정책자금 역량 진단',
      desc: '대표님이 직접 신청하시기 전, 대표님의 성장 잠재력과 경쟁력을 면밀히 분석하여 최적의 정책자금 지원사업을 선별합니다.',
      tags: ['대표자 역량 분석', '요건 적합성 분석', '경쟁력 진단'],
    },
    {
      title: '맞춤형 전략 수립',
      desc: '신청 전 준비 단계에서 대표님에게 최적화된 자금 포트폴리오를 설계하고, 대표님이 직접 진행하실 때 사용할 맞춤 전략을 수립합니다.',
      tags: ['공고 정보 분석', '맞춤 포트폴리오', '전략 사전 설계'],
    },
    {
      title: '사전 준비 완성도 극대화',
      desc: '대표님이 직접 작성하실 때 활용할 사업계획 전략과 필수 증빙 구성 방향을 사전에 철저히 준비합니다.',
      tags: ['계획 전략 수립', '증빙 방향 설계', '준비 완성도 강화'],
    },
    {
      title: '대표님 실행을 위한 지속 지원',
      desc: '대표님이 직접 진행하시는 협약부터 정산까지의 전 과정에서, 연계 사업 발굴로 지속적인 성장을 함께 준비합니다.',
      tags: ['프로세스 가이드', '정산 방향 안내', '연계 사업 발굴'],
    },
  ]
      ...
      <div className="relative z-[1] max-w-[1200px] mx-auto px-5">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-[rgba(224,242,241,0.8)] [text-shadow:0_0_10px_rgba(0,0,0,0.3)]">
            제이앤아이 파트너스가 제공하는 대표자 경쟁력 극대화 솔루션
          </p>
          ...
          <div className="flex-1 relative z-[2]">
            ...
            <div className="mt-8 md:mt-0">
              ...
              <p className="text-[15px] md:text-[17px] text-[rgba(224,242,241,0.9)] leading-[1.8] mb-6 break-keep">
                정책자금 확보는{' '}
                <span className="text-gold font-bold">전문가와의 협업이 핵심</span>
                입니다.
                <br className="hidden md:inline" />{' '}
                저희는 성장 전략 전문가로서, 대표님의 자금조달 구조를 체계적으로 분석하고
                <br className="hidden md:inline" />{' '}
                최적의 자금 조달 방안을 제시하여 실질적인 성과를 창출합니다.
              </p>
              <p className="text-[15px] md:text-[17px] text-[rgba(224,242,241,0.9)] leading-[1.8] mb-6 break-keep">
                많은 대표님들이 전문 지원 없이 소중한 기회를 놓치고 있습니다.
                <br className="hidden md:inline" />{' '}
                <span className="text-gold font-bold">
                  대표님이 최선의 자금 전략으로 성장할 수 있도록 함께하겠습니다.
                </span>
              </p>
