        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-[60px] items-center text-center md:text-left">
          ...
          <div className="text-body px-5 md:px-0">
            ...
            <p className="text-[15px] md:text-[20px] leading-[1.6] mb-6 md:mb-10 text-body [text-shadow:0_0_10px_rgba(0,0,0,0.3)] break-keep">
              대표님 맞춤형 자금 전략 수립부터<br className="md:hidden" /> 성공적인 조달까지<br />
              체계적인 지원으로<br className="md:hidden" /> 대표님의 성장을 지원합니다
            </p>
          ...
          <div className="block md:hidden bg-[rgba(30,60,120,0.15)] backdrop-blur-[15px] border border-[rgba(212,175,55,0.3)] rounded-2xl p-4 mx-5 mb-3 shadow-[0_0_30px_rgba(139,111,63,0.4),0_8px_32px_rgba(212,175,55,0.2)]">
            <div className="grid grid-cols-3 text-center">
              <div className="px-2 border-r border-[rgba(212,175,55,0.3)]">
                <div className="text-[22px] font-bold text-gold mb-0.5 [text-shadow:0_0_15px_rgba(212,175,55,0.8)]">418+</div>
                <div className="text-[11px] text-body font-medium">성공 기업</div>
              </div>
              <div className="px-2 border-r border-[rgba(212,175,55,0.3)]">
                <div className="text-[22px] font-bold text-gold mb-0.5 [text-shadow:0_0_15px_rgba(212,175,55,0.8)]">2.8억</div>
                <div className="text-[11px] text-body font-medium">평균 조달액</div>
              </div>
              <div className="px-2">
                <div className="text-[22px] font-bold text-gold mb-0.5 [text-shadow:0_0_15px_rgba(212,175,55,0.8)]">96%</div>
  ...
  const steps = [
    {
      step: 'STEP 01',
      title: '무료 상담 및 역량 분석',
      desc: '대표님의 재무 현황과 자금 수요를 분석하여 최적의 금융 솔루션을 제안합니다',
      details: ['재무 현황 분석', '자금 수요 파악'],
      icon: (
    ...
    },
    {
      step: 'STEP 02',
      title: '맞춤형 자금 전략 수립',
      desc: '정책자금, 대출, 보증서 등 다양한 금융 옵션을 검토하여 최적의 조합을 제시합니다',
      details: ['최적 조합 제시', '금융 비용 절감'],
      icon: (
        <svg viewBox="0 0 24 24" className="w-7 h-7 md:w-10 md:h-10 fill-gold drop-shadow-[0_0_5px_rgba(212,175,55,0.8)]">
    ...
    {
      step: 'STEP 03',
      title: '서류 정보 제공 및 심사 대비 전략',
      desc: '대표님이 직접 작성하실 수 있도록 서류 정보를 제공하고 심사 통과 전략을 체계적으로 제시합니다',
      details: ['서류 정보 제공', '심사 대비 전략'],
      icon: (
        <svg viewBox="0 0 24 24" className="w-7 h-7 md:w-10 md:h-10 fill-gold drop-shadow-[0_0_5px_rgba(212,175,55,0.8)]">
    ...
    },
    {
      step: 'STEP 04',
      title: '자금 집행 및 사후 관리',
      desc: '자금 수령 후에도 실적 관리와 추가 자금 연계로 지속적인 성장을 지원합니다',
      details: ['실적 관리 지원', '추가 자금 연계'],
      icon: (
        <svg viewBox="0 0 24 24" className="w-7 h-7 md:w-10 md:h-10 fill-gold drop-shadow-[0_0_5px_rgba(212,175,55,0.8)]">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-5 relative z-[1]">
        ...
        <div className="text-center mt-[35px] md:mt-[50px] p-[30px_22px] md:p-[40px_35px] bg-[rgba(30,60,120,0.15)] backdrop-blur-[20px] rounded-2xl md:rounded-[20px] border border-[rgba(212,175,55,0.3)] shadow-[0_0_30px_rgba(139,111,63,0.4),0_8px_32px_rgba(212,175,55,0.2),inset_0_1px_0_rgba(212,175,55,0.1)]">
          ...
          <p className="text-[14px] md:text-[17px] text-body mb-5 md:mb-[25px] leading-[1.5] md:leading-[1.6] break-keep">
            제이앤아이 파트너스의 전문 지원으로 정책자금 성공률을 높이세요
          </p>
          <a
            href="#consult-form"
            onClick={scrollToForm}
...
function DetailSection() {
  ...
  const tabData: Record<string, TabData> = {
    policy: {
      name: '정부 정책자금 신청 정보',
      summary: '창업·운전·시설자금 등 대표님 성장 단계별 맞춤형 정책자금 정보',
      ...
      serviceTitle: '제이앤아이 파트너스 제공 서비스',
      services: [
        { title: '자금 정보 분석', desc: '대표님 상황별 최적 정책자금 정보' },
        { title: '서류 작성 교육', desc: '사업계획서 작성 방법 교육' },
        { title: '심사 전략 코칭', desc: '대표님이 직접 준비하는 전략 코칭' },
      ],
    },
    loan: {
      name: '대표님 맞춤형 대출 정보',
      summary: '은행·저축은행·캐피탈 등 다양한 금융기관 대출 정보 제공',
    ...
    consulting: {
      name: '대표님 자금전략 교육',
      summary: '대표님이 직접 수립하고 실행하는 맞춤형 자금전략 교육 및 코칭',
      highlightLabel: '성공률',
      highlightValue: '96%',
      info: [
